...
public class RuleServiceType11TestSuite {
	...
	@Test
	public void type01_11_id2010() throws Exception {
		assertTrue(Results.TYPE_11_Unknown.equals(runType("/rules/type_11_id2010.txt")));
	}

	@Test
	public void type01_11_id2076() throws Exception {
		assertTrue(Results.TYPE_11_Unknown.equals(runType("/rules/type_11_id2076.txt")));
	}
