...
public class RuleServiceType04TestSuite {
	...
	@Test
	public void type01_04_id126() throws Exception {
		assertTrue(Results.TYPE_04_AsymptomaticHighSuspicion.equals(runType("/rules/type_04_id126.txt")));
	}

	private Results runType(String file) throws Exception {
		String json  = IOUtils.toString(RuleServiceType04TestSuite.class.getResourceAsStream(file), StandardCharsets.UTF_8);
