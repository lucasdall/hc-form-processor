...
public class RuleServiceType09TestSuite {
	...
	@Test
	public void type01_09_id152() throws Exception {
		assertTrue(Results.TYPE_09_DiagnosedNotCuredAsymptomatic.equals(runType("/rules/type_09_id152.txt")));
	}

	private Results runType(String file) throws Exception {
		String json  = IOUtils.toString(RuleServiceType09TestSuite.class.getResourceAsStream(file), StandardCharsets.UTF_8);
